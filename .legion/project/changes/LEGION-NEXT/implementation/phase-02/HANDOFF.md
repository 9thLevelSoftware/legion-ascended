...
- Legacy `.planning` import dry-run/apply/rollback with checksummed backups, explicit review requirement, source preservation, safe backup roots, and rollback manifest integrity checks.
...
- `pnpm --filter @legion/legacy-bridge test`: PASS, 28 tests. Evidence: `docs/next/evidence/P02-CLOSEOUT/legacy-bridge-test.log`.
